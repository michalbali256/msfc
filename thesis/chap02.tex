...
%Neviem ci je to zrozumitelne alebo nejaka takato poznamka by sa hodila The word class is overloaded in the next few paragraphs: one meaning is traffic control class and second is C++ class. We will use C++ class when we mean 
